...
- [[DOP-23968] Add .get_exlude_packages() to SparkS3 and Kafka](https://github.com/MobileTeleSystems/onetl/pull/341) on [MobileTeleSystems/onetl](https://github.com/MobileTeleSystems/onetl)
